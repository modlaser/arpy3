                        ...
                        if cmd == "unsend off":
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                if msg.to in protecARoin: md+="┣🇮🇩┫ ✔️ ProtecARoin「ON」\n"
                                else: md+="┣🇮🇩┫ ❌ ProtecARoin「OFF」\n"
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"❧ BOT Protection\n\n❧ PROTECT URL :\n"+ma+"\n❧ PROTECT KICK :\n"+mb+"\n❧ PROTECT JOIN :\n"+md+"\n❧ PROTECT CANCEL:\n"+mc+"\n❧ PROTECT INVITE :\n"+me+"\nTotal「%s」Protect yang aktif" %(str(len(protectqr)+len(protectkick)+len(protecARoin)+len(protectcancel)+len(protectinvite))))
...
#===========Hiburan============#
                          ...
                          if msg._from in admin: 
                            try:
                                ...
                                cl.sendMessage(msg.to, "「 Arif Telepon 」\n❧ Status : Success!!!\n❧ No Tujuan : "+nohp)
                            except Exception as error:
                                pass  
                          ...
                          if msg._from in admin: 
                            try:
                                ...
                                cl.sendMessage(msg.to, "「 Arif Sms 」\n❧ Status : Success!!!\n❧ No Tujuan : "+nohp)
                            except Exception as error:
                                pass                            
